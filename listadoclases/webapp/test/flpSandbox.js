		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Activacion de Clases",
									"targetURL": "#listadoclaseslistadoclases-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"listadoclaseslistadoclases-display": {
								"semanticObject": "listadoclaseslistadoclases",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=listadoclases.listadoclases",
									"url": sap.ui.require.toUrl("listadoclases/listadoclases")
								}
							}
						}
					}
